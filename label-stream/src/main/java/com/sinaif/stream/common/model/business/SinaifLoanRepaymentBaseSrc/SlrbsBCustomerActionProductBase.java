package com.sinaif.stream.common.model.business.SinaifLoanRepaymentBaseSrc;
 ...
 * @Author : pingping.tu
 * @File : SlrbsBCustomerActionProductBase.py
 * @Email : flatuer@gmail.com
 * @Description :
 */
@KuduDomain(table = "impala::stream_test.b_customer_action_product")
public class SlrbsBCustomerActionProductBase extends CommonBusiness {
    ...
    public Double oldcapitalamount;
